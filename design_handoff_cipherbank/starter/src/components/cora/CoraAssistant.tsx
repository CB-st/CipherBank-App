...
export function CoraAssistant({ screen }: { screen: string }) {
  ...
  return (
    <View pointerEvents="box-none" style={{ position: 'absolute', right: 16, bottom: 92, alignItems: 'flex-end', gap: 10 }}>
      {open ? (
      ...
      <Pressable onPress={() => setOpen((o) => !o)}
        style={{ width: 56, height: 56, borderRadius: 28, backgroundColor: '#1C1430', borderWidth: 2, borderColor: color.gold,
