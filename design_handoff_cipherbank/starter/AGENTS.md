...
- **API wire format:** SCREAMING_SNAKE everywhere — `docs/CB_FullAPIRef.html` (full catalog), `docs/CB_InitialAPIRef.html` (PriceCache), `docs/PUBLIC_API.md`. Boundary codec: `src/lib/wireFormat.ts`. Regenerate HTML: `npm run api-ref`.
