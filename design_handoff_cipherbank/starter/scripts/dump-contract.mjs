...
const ENDPOINTS = [
  ...
  ['GET', '/rates', 'deprecated → POST /currencies+/iquote'],
  ['POST', '/currencies', 'public · fixtures/rates.json codes'],
  ['POST', '/iquote', 'public · CB_InitialAPIRef'],
  ['POST', '/quote', 'public · CB_InitialAPIRef'],
  ['POST', '/test', 'public · connectivity'],
