...
End-to-end tests driving the MAUI app through `PageObjects/`. Highest value, highest cost tier — reserve for user journeys, not exhaustive branch coverage (that belongs in CipherBank-app.Tests).
