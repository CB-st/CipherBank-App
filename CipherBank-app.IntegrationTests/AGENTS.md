...
Integration tests exercising real adapters (HTTP, mock servers — see `MockServerFixture.cs`) rather than in-process fakes. Slower than unit tests; keep provider-backed, not mocked.
