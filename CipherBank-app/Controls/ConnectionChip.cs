...
public sealed class ConnectionChip : ContentView
{
    ...
    private void Apply()
    {
        ...
        Color accent = online ? Color.FromArgb("#3FA46A") : ThemeTokens.Get("Danger");
        Color text = online ? Color.FromArgb("#2E7D51") : ThemeTokens.Get("Danger");
        _frame.BackgroundColor = online ? Color.FromArgb("#143FA46A") : Color.FromArgb("#14C0574B");
        _dot.Color = accent;
